...
public class ApplicationMain {
    ...
    public static void myConsoleAppender() {
        MyConsoleAppender myConsoleAppender = new MyConsoleAppender(ApplicationMain.class,"src\\main\\resources\\consoleAppender\\log4j.xml");
    ...
    public static void myFileAppender() {
        MyFileAppender myFileAppender = new MyFileAppender(ApplicationMain.class, "src\\main\\resources\\fileAppender\\log4j.xml");
