...
public class ApplicationMain {
    ...
    public static void myFileAppender() {
        MyFileAppender myFileAppender = new MyFileAppender(ApplicationMain.class, "src\\main\\resources\\myFileAppender\\log4j.xml");
    ...
    public static void myRollingFileAppender() {
        MyRollingFileAppender myRollingFileAppender = new MyRollingFileAppender(ApplicationMain.class, "src\\main\\resources\\myRollingFileAppender\\log4j.xml");
    ...
    public static void myDailyRollingFileAppender() {
        MyDailyRollingFileAppender myDailyRollingFileAppender = new MyDailyRollingFileAppender(ApplicationMain.class, "src\\main\\resources\\myDailyRollingFileAppender\\log4j.xml");
